...
export default function OurWork() {
  return (
    <div className={cn('bg-[#292929] text-white h-full w-full min-h-screen pt-20' , inter.className)}>
      <NavBar />
      <div className='max-w-6xl mx-auto py-10 xl:p-0 p-6 max-md:text-center w-full'>
